...
def main(
    ...
    feature_names = ['ImageNet', 'RadImageNet', 'Radiomics']
    for features_name in feature_names:
        print("Results using {} features:".format(features_name))
        ...
        if not use_val_set:
            ...
            print("Sampling held-out set from training set instead of using validation set.")
